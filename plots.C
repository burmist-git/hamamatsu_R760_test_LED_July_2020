...
Int_t plots(){
  ...
  TString fileN;
  fileN = "../root_data_L2/Run_001_Data_7_9_2020_Binary/Run_001_Data_7_9_2020_Binary.bin.L1.root.L2.root";

  TFile *f1 = new TFile(fileN.Data());

  TH1D *h1_1 = (TH1D*)f1->Get("h1_rateCounterUSBWC_ch_0");
  TH1D *h1_2 = (TH1D*)f1->Get("h1_rateCounterUSBWC_ch_1");
